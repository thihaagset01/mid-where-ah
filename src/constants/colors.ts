/**
 * MidWhereAh Color System - Exact purple theme with equity indicators
 */

export const colors = {
  primary: {
    main: '#8B5DB8',         // Primary purple - NEVER change
    light: '#A477CC',        
    dark: '#6A4A8C',         
    background: '#E8DFF5'    
  },
...
export type EquityColor = keyof typeof colors.equity;
export type TransportColor = keyof typeof colors.transport;
